...
select tb_produtos.nome as produto, tb_produtos.preco, tb_categoria.descricao as categoria from tb_produtos 
inner join tb_categoria on tb_produtos.categoria_id = tb_categoria.id where tb_categoria.descricao like "Aves";